...
namespace th
{
	...
	bool Reader::readItems(vector<Item>& items) noexcept
	{
		items.clear();
	...
	bool Reader::readEnemies(vector<Enemy>& enemies) noexcept
	{
		enemies.clear();
	...
	bool Reader::readBullets(vector<Bullet>& bullets) noexcept
	{
		bullets.clear();
	...
	bool Reader::readLasers(vector<Laser>& lasers) noexcept
	{
		lasers.clear();
